...
public class singlePlayer{
        ...
        public static void singlePlayer(){
         ...
         while(andamento==true){
            ...
            vitoria = verificaVitoria(velha, player1, pontPlayer1, pontPlayer2);
            if(vitoria == true){
            ...
            try{
                if(verificarJogada(velha,jogar(scanner,simboloAtual,player1),simboloAtual)){
                    if(simboloAtual == 'X'){
                        simboloAtual = 'O';
                    }else{
                        simboloAtual = 'X';
         ...
         System.out.println("Fim de jogo.");
            ...
            public static int[] jogar(Scanner scanner, char simboloAtual, String player1) {
                int[] p = new int[2];
                ...
                p[1] = scanner.nextInt();
                        ...
                        System.out.printf("%s (%c)\n", "Quem joga: Player 2", simboloAtual);
            ...
            public static boolean verificaVitoria(Campo[][] velha, String player1,int pontPlayer1,int pontPlayer2) {
                ...
                for (int i = 0; i < 3; i++) {
                    if ((velha[i][0].getSimbolo() == jogador && velha[i][1].getSimbolo() == jogador && velha[i][2].getSimbolo() == jogador) ||
                        ...
                        if(jogador == 'X'){
                            ...
                            System.out.printf("Player 2 (%c) venceu.%n", jogador);
                            pontPlayer2++;
                            System.out.println("Placar: (X)"+pontPlayer1+" (O)"+pontPlayer2);                            
                            return true;
                        }
